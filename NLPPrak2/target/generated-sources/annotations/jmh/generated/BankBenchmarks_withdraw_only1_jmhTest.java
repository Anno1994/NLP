...
public final class BankBenchmarks_withdraw_only1_jmhTest {
    ...
    public BenchmarkTaskResult withdraw_only1_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
    ...
    public BenchmarkTaskResult withdraw_only1_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
    ...
    public BenchmarkTaskResult withdraw_only1_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
    ...
    public BenchmarkTaskResult withdraw_only1_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
            BankBenchmarks_StateClass_jmhType l_stateclass2_G = _jmh_tryInit_f_stateclass2_G(control, threadParams);
