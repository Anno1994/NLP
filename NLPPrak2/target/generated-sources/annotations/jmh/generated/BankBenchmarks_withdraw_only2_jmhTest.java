...
public final class BankBenchmarks_withdraw_only2_jmhTest {
    ...
    public BenchmarkTaskResult withdraw_only2_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_bankbenchmarks0_0.withdraw_only2(l_stateclass2_G));
                res.allOps++;
            }

            withdraw_only2_thrpt_jmhStub(control, res, l_stateclass2_G, l_bankbenchmarks0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "withdraw_only2", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void withdraw_only2_thrpt_jmhStub(InfraControl control, RawResults result, BankBenchmarks_StateClass_jmhType l_stateclass2_G, BankBenchmarks_jmhType l_bankbenchmarks0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult withdraw_only2_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
            ...
            withdraw_only2_avgt_jmhStub(control, res, l_stateclass2_G, l_bankbenchmarks0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_bankbenchmarks0_0.withdraw_only2(l_stateclass2_G));
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "withdraw_only2", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void withdraw_only2_avgt_jmhStub(InfraControl control, RawResults result, BankBenchmarks_StateClass_jmhType l_stateclass2_G, BankBenchmarks_jmhType l_bankbenchmarks0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult withdraw_only2_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
            ...
            withdraw_only2_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_stateclass2_G, l_bankbenchmarks0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_bankbenchmarks0_0.withdraw_only2(l_stateclass2_G));
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "withdraw_only2", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void withdraw_only2_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BankBenchmarks_StateClass_jmhType l_stateclass2_G, BankBenchmarks_jmhType l_bankbenchmarks0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult withdraw_only2_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            BankBenchmarks_jmhType l_bankbenchmarks0_0 = _jmh_tryInit_f_bankbenchmarks0_0(control, threadParams);
            BankBenchmarks_StateClass_jmhType l_stateclass2_G = _jmh_tryInit_f_stateclass2_G(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            withdraw_only2_ss_jmhStub(control, batchSize, res, l_stateclass2_G, l_bankbenchmarks0_0, l_blackhole1_1);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "withdraw_only2", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void withdraw_only2_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BankBenchmarks_StateClass_jmhType l_stateclass2_G, BankBenchmarks_jmhType l_bankbenchmarks0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
