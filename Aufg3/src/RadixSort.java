...
public class RadixSort {
    ...
    // Falls jeder Thread sein eigenes Array hätte, könnten alle zur selben Zeit schreiben, und der
    // Master-Thread könnte alle Teil-Ergebnise am Ende zu einem GesamtErgebnis zusammenfügen.

    // zu b.)
    // Schritt 2 lässt sich nicht parallelisierten, da die Werte aufaddiert werden, sind diese
